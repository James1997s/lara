...
struct CreditsView: View {
    var body: some View {
        NavigationStack {
            List {
                LinkCreditCell(name: "rooootdev", description: "Main Developer", url: "https://github.com/rooootdev") {
                ...
                LinkCreditCell(name: "AppInstalleriOS", description: "Helped me with offsets and lots of other stuff. This project wouldn't have been possible without him!", url: "https://github.com/AppInstalleriOSGH") {
